...
require "C:/Apache24/htdocs/vendor/autoload.php";
require 'Tfidf.php';
...
foreach ($records as $record) {
    //do something here
    $playstation[$i] = $record['topik'];
    $desc[$i] = $record['deskripsi'];
...
else echo "Sorry, there is no answer for that question.
            Please put more details to the previous question. 
            Thank you.";
